================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : ShowPixels Project Overview
===============================================================================

The application wizard has created this ShowPixels application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your ShowPixels application.
...
ShowPixels.h
    ...
    CShowPixelsApp application class.

ShowPixels.cpp
    This is the main application source file that contains the application
    class CShowPixelsApp.
...
res\ShowPixels.ico
    ...
    icon is included by the main resource file ShowPixels.rc.
...
ShowPixelsDlg.h, ShowPixelsDlg.cpp - the dialog
    These files contain your CShowPixelsDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in ShowPixels.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CShowPixelsDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named ShowPixels.pch and a precompiled types file named StdAfx.obj.
